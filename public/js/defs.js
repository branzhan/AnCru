...
var FilesBoard = new Array(BOARD_SQ_NUM);
var RanksBoard = new Array(BOARD_SQ_NUM);
...
function fileCharToInt(f) {
    return f.charCodeAt(0) - 97;
}

//Returns the square number given the file and rank
function FR2SQ(f, r) {
    return ((21 + f) + (r * 10));
}
...
var PieceVal= [ 0, 128, 721, 825, 1276, 2538, 50000, 128, 721, 825, 1276, 2538, 50000  ];
...
//Number of directions a piece can move, wP, ..., bK
var DirNum = [ 0, 0, 8, 4, 4, 8, 8, 0, 8, 4, 4, 8, 8 ];
var PieceDir = [ 0, 0, NDir, BDir, RDir, KDir, KDir, 0, NDir, BDir, RDir, KDir, KDir ];
...
var Sq160ToSq64 = new Array(BOARD_SQ_NUM);
...
//Castle Permission &= CastlePerm[from]
var CastlePerm = [
...
//0000 0000 0000 0011 1111 0000 0000 -> To 0x7F
function TOSQ(m) {
    return ((m >> 7) & 0x7F);
}

//0000 0000 0011 1100 0000 0000 0000 -> To 0x7F
function CAPTURED(m) {
    return ((m >> 14) & 0xF);
}
...
//0000 0000 0100 0000 0000 0000 0000 -> En Passant Flag
var MFLAGEP = 0x40000;
//0000 0000 1000 0000 0000 0000 0000 -> Pawn Start Flag
var MFLAGPS = 0x80000;
//0001 0000 0000 0000 0000 0000 0000 -> Castle Start Flag
var MFLAGCA = 0x1000000;
//0000 0000 0111 1100 0000 0000 0000 -> Capture Flag; Combines En Passant with captured
var MFLAGCAP = 0x7C000;
//0000 1111 0000 0000 0000 0000 0000 -> Promotion Flag
